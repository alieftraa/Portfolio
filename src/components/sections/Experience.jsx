...
import { Briefcase, Globe, GraduationCap, Compass, Award } from "lucide-react";
...
export default function Experience() {
  ...
  const openCertModal = (certificate) => {
                    ...
                    <div className="flex gap-6 md:gap-8 group">
                      ...
                      >
                        ...
                        <div className="exp-content-header">
                          ...
                          {/* Certificate button — only if certificate exists */}
                          {exp.certificate && (
                            <button
